...
from turbobus.schema import BufferRegistration
...
class SharedPinnedCpuBufferTest(unittest.TestCase):
    ...
    def test_buffer_registration_contains_daemon_payload_fields(self) -> None:
        allocator = SharedPinnedCpuBufferAllocator(name_prefix="tb-test")
    ...
    def test_cuda_ipc_device_buffer_builds_daemon_registration(self) -> None:
        ...
        self.assertEqual(registration.metadata["allocation_base_ptr"], 1218)
        self.assertEqual(registration.metadata["allocation_size_bytes"], 4096)
